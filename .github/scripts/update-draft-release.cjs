    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'Summarize this pull request for release notes. Be concise and focus on user-facing changes. Include the type of change (e.g., "Fix", "Feature", "Enhancement") at the beginning.'
          },
          {
            role: 'user',
            content: `${title}\n\n${body}`
